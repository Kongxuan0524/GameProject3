...
public class NetworkCtrl
{
    ...
    {
        GTEventCenter.DelHandler(GTEventID.TYPE_CONNECT_SUCCESS,                 OnConnectSuccess);
        GTEventCenter.DelHandler<MessageRetCode>(GTEventID.TYPE_CONNECT_FAIL,    OnConnectFail);
        GTEventCenter.DelHandler(GTEventID.TYPE_CONNECT,                         OnConnectStart);
    }
    ...
    {
        GTWindowManager.Instance.CloseWindow(EWindowID.UINetWaiting);
    }
