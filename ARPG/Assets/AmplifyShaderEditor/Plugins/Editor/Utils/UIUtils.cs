...
namespace AmplifyShaderEditor
{
	...
	public class UIUtils
	{
		...
		public static void InitMainSkin()
		{
			...
			PreviewExpander = CustomStyle( AmplifyShaderEditor.CustomStyle.NodePreviewExpander );
			PreviewCollapser = CustomStyle( AmplifyShaderEditor.CustomStyle.NodePreviewCollapser );
