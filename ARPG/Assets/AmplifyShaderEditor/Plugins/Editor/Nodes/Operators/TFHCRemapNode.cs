...
namespace AmplifyShaderEditor
{
	...
	public sealed class TFHCRemap : DynamicTypeNode
	{
		...
		protected override void CommonInit( int uniqueId )
		{
			...
			m_inputPorts[ 1 ].PreviewSamplerName = "_MinOld";
			m_inputPorts[ 2 ].PreviewSamplerName = "_MaxOld";
			m_inputPorts[ 3 ].PreviewSamplerName = "_MinNew";
			m_inputPorts[ 4 ].PreviewSamplerName = "_MaxNew";
		}
