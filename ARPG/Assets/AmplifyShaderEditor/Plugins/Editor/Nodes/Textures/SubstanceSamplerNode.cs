...
namespace AmplifyShaderEditor
{
	...
	public sealed class SubstanceSamplerNode : PropertyNode
	{
		...
		public override void Draw( DrawInfo drawInfo )
		{
			...
			m_proceduralMaterial = ( ProceduralMaterial ) EditorGUI.ObjectField( pickerArea, m_proceduralMaterial, m_type, false );
		...
		public override void DrawProperties()
		{
			...
			EditorGUI.BeginChangeCheck();
			m_proceduralMaterial = ( ProceduralMaterial ) EditorGUILayout.ObjectField( SubstanceStr, m_proceduralMaterial, m_type, false );
			if ( EditorGUI.EndChangeCheck() )
			{
				Texture[] textures = m_proceduralMaterial != null ? m_proceduralMaterial.GetGeneratedTextures() : null;
				if ( textures != null )
