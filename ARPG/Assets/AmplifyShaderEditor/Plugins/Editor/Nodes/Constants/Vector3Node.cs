	...
	public sealed class Vector3Node : PropertyNode
	{
		...
		public override void SetPreviewInputs()
		{
			...
			if ( m_materialMode && m_currentParameterType != PropertyType.Constant )
				UIUtils.CurrentWindow.PreviewMaterial.SetVector( "_InputVector", new Vector4( m_materialValue[ 0 ], m_materialValue[ 1 ], m_materialValue[ 2 ], 0 ) );
			else
				UIUtils.CurrentWindow.PreviewMaterial.SetVector( "_InputVector", new Vector4( m_defaultValue[ 0 ], m_defaultValue[ 1 ], m_defaultValue[ 2 ], 0 ) );
		}
